# trainUberML_LR.py
# Uber ride success prediction using Logistic Regression
...
test_predictions.to_csv("test_predictions_LR.csv", index=False)
...
# --------------------------
model_filename = "modelUberML_LR.pk1"
...
print("Test predictions saved as test_predictions_LR.csv")
